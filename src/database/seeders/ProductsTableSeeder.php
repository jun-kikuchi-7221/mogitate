...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Product::create([
            'name' => 'キウイ',
            'price' => '800',
            'image' => 'public/products/kiwi.png',
        ...
        Product::create([
            'name' => 'ストロベリー',
            'price' => '1200',
            'image' => 'public/products/strawberry.png',
        ...
        Product::create([
            'name' => 'スイカ',
            'price' => '700',
            'image' => 'public/products/watermelon.png',
        ...
        Product::create([
            'name' => 'ピーチ',
            'price' => '1000',
            'image' => 'public/products/peach.png',
        ...
        Product::create([
            'name' => 'シャインマスカット',
            'price' => '1400',
            'image' => 'public/products/muscat.png',
        ...
        Product::create([
            'name' => 'パイナップル',
            'price' => '800',
            'image' => 'public/products/pineapple.png',
        ...
        Product::create([
            'name' => 'ブドウ',
            'price' => '1100',
            'image' => 'public/products/grapes.png',
        ...
        Product::create([
            'name' => 'バナナ',
            'price' => '600',
            'image' => 'public/products/banana.png',
        ...
        Product::create([
            'name' => 'メロン',
            'price' => '900',
            'image' => 'public/products/melon.png',
