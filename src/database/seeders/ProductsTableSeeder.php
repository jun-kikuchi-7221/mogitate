...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Product::create([
            'name' => 'キウイ',
            'price' => '800',
            'image' => 'src/storage/images/kiwi.png',
        ...
        Product::create([
            'name' => 'ストロベリー',
            'price' => '1200',
            'image' => 'src/storage/images/strawberry.png',
        ...
        Product::create([
            'name' => 'オレンジ',
            'price' => '850',
            'image' => 'src/storage/images/orange.png',
        ...
        Product::create([
            'name' => 'スイカ',
            'price' => '700',
            'image' => 'src/storage/images/watermelon.png',
        ...
        Product::create([
            'name' => 'ピーチ',
            'price' => '1000',
            'image' => 'src/storage/images/peach.png',
        ...
        Product::create([
            'name' => 'シャインマスカット',
            'price' => '1400',
            'image' => 'src/storage/images/muscat.png',
        ...
        Product::create([
            'name' => 'パイナップル',
            'price' => '800',
            'image' => 'src/storage/images/pineapple.png',
        ...
        Product::create([
            'name' => 'ブドウ',
            'price' => '1100',
            'image' => 'src/storage/images/grapes.png',
        ...
        Product::create([
            'name' => 'メロン',
            'price' => '900',
            'image' => 'src/storage/images/melon.png',
